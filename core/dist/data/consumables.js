...
exports.planetCards = exports.tarotCards = exports.spectralCards = void 0;
exports.spectralCards = {
    data: [
        {
            Spectral: {
                value: "Familiar",
            ...
            Description: {
                value: "Destroy 1 random card in your hand, but add 3 random Enhanced face cards instead.",
                weight: 0,
            },
        },
        {
            ...
            Description: {
                value: "Destroy 1 random card in your hand, but add 2 random Enhanced Aces instead.",
                weight: 1,
            },
        },
        {
            ...
            Description: {
                value: "Destroy 1 random card in your hand, but add 4 random Enhanced numbered cards instead.",
                weight: 2,
            },
        },
        {
        ...
        },
        {
            ...
            Description: {
                value: "Add Foil, Holographic, or Polychrome edition (determined at random) to 1 selected card in hand.",
                weight: 4,
            },
        },
        {
            ...
            Description: {
                value: "Creates a random Rare Joker (must have room), but sets money to $0.",
                weight: 5,
            },
        },
        {
        ...
        },
        {
            ...
            Description: {
                value: "Converts all cards in hand to a single random rank, but -1 hand size.",
                weight: 7,
            },
        },
        {
            ...
            Description: {
                value: "Add Negative to a random Joker, but -1 hand size. (Hand size reduction on use increases by 1 for every time Ectoplasm is used in a run, eg. using Ectoplasm 3 times in the same run decreases hand size by a total of 6 (1+2+3))",
                weight: 8,
            },
        },
        {
        ...
        },
        {
            ...
            Description: {
                value: "Creates a copy of 1 of your Jokers at random, then destroys the others, leaving you with two identical Jokers. (Editions are also copied, except Negative)",
                weight: 10,
            },
        },
        {
        ...
        },
        {
            ...
            Description: {
                value: "Creates 2 exact copies (including Enhancements, Editions and Seals) of a selected card in your hand.",
                weight: 15,
            },
        },
        {
            ...
            Description: {
                value: "Creates a Legendary Joker (Must have room). Artwork: This card is animated, with the gem beating like a heart, or perhaps something inside is trying to break out...",
                weight: 16,
            },
        },
        {
            ...
            Description: {
                value: "Upgrades every poker hand (including secret hands not yet discovered) by one level.",
                weight: 17,
            },
        },
    ],
    ...
    data: [
        {
            ...
            Description: {
                value: "Creates the last Tarot or Planet card used during this run The Fool excluded",
                weight: 0,
            },
        },
        {
        ...
        },
        {
            ...
            Description: {
                value: "1 in 4 chance to add Foil, Holographic, or Polychrome edition to a random Joker",
                weight: 10,
            },
        },
        {
            ...
            Description: {
                value: "Increases rank of up to 2 selected cards by 1 (For example, 4 to 5, 10 to Jack, King to Ace, Ace to 2.)",
                weight: 11,
            },
        },
        {
        ...
        },
        {
            ...
            Description: {
                value: "Select 2 cards, convert the left card into the right card (Drag to rearrange)",
                weight: 13,
            },
        },
        {
        ...
        },
        {
            ...
            Description: {
                value: "Creates a random Joker card (Must have room),The World (XXI),Converts up to 3 selected cards to Spade suit icon Spades",
                weight: 20,
            },
        },
    ],
